...
//+双人
//+彩色
//检查所有alloc是否分配成功,并将类似部分用函数或宏统一代换,To do s maked by repeated '/'
////debug一下无敌模式
//解决输入'￥'等中文字符时的'bug'
...
//version 1.1.0: the *"world" is updated to be *soft, thused
...
void cursor_controller(BOOL sign) //控制光标显示与否
{
    CONSOLE_CURSOR_INFO cursor_info = {1, sign};
